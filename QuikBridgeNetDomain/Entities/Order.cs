...
public class Order
{
    ...
    public string firmid {get; set;} = string.Empty; // Идентификатор фирмы
    ...
    public string linkedorder {get; set;} = string.Empty; // Номер заявки в торговой системе
    ...
    public string class_code {get; set;} = string.Empty; // Код класса заявки
    ...
    public string reject_reason {get; set;} = string.Empty; // Причина отклонения заявки брокером
