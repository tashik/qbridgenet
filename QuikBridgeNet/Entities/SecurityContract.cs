...
public class SecurityContract
{
    ...
    public string base_active_classcode { get; set; }
    public string base_active_seccode { get; set; }
    ...
    public string cusip_code { get; set; }
    ...
    public string first_currcode { get; set; }
    ...
    public string ric_cod { get; set; }
    public int scale { get; set; }
    public string sec_code { get; set; }
    public int second_curr_qty_scale { get; set; }
    public string second_currcode { get; set; }
    public string sedol_code { get; set; }
    public int settle_date { get; set; }
    public string settlecode { get; set; }
    public string short_name { get; set; }
    public string step_price_currency { get; set; }
